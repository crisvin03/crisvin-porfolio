...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#070b15] text-slate-100 relative overflow-x-hidden w-full max-w-full">
      <Starfield />
      <FloatingElements />
      ...
      {!loading && (
        <>
          ...
          {/* Back to top button - always follows user (hidden during loading) */}
          <BackToTop />
        </>
      )}
    </div>
