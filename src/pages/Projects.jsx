...
const projects = [
  ...
  {
    name: "BuMo",
    desc: "Mobile-first experiment / utilities bundle. A Ride Sharing App.",
  ...
  {
    name: "PanahON",
    desc: "Comprehensive React Native weather and typhoon tracking app for the Philippines.",
    stack: ["React Native", "Expo", "TypeScript"],
    live: null,
    repo: "https://github.com/crisvin03/panahON",
    image: gh("panahON"),
    stars: 0,
  },
  {
    name: "NSTP",
    desc: "National Service Training Program implementation project.",
    stack: ["React", "Vite", "Tailwind", "Framer Motion"],
    live: null,
    repo: "https://github.com/crisvin03/NSTP",
    image: gh("NSTP"),
    stars: 0,
  },
];
...
export default function Projects() {
  return (
    <section id="projects" className="scroll-mt-24 py-16 sm:py-20 w-full overflow-x-hidden">
