...
export default function Home() {
  return (
    <section id="home" className="relative py-16 sm:py-20 md:py-28 w-full overflow-x-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-8 md:gap-10 items-center w-full">
        <motion.div
