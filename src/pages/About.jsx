...
import {
  ...
  Sparkles, Code2, Rocket, Facebook, Instagram, Mail
} from "lucide-react";
...
const timeline = [
  {
    ...
    period: "2023 — Present",
    points: [
      "React / Next.js frontends with Tailwind, motion, and accessible UI.",
      "Node/Express APIs; authentication; REST/JSON; deployment on Vercel.",
      "Mobile experiments with React Native / Expo and Flutter + Firebase.",
    ],
  },
  {
    ...
    period: "2022 — 2023",
    points: [
      "Built small business websites and internal tools.",
      "Integrated Firebase (auth, Firestore) and Stripe checkouts.",
      "Collaborated with designers; component libraries and design tokens.",
    ],
  },
  {
    title: "Education",
    period: "Ongoing",
    points: [
      "Computer science foundations, algorithms, and web technologies.",
      "Constant learning via side projects and GitHub contributions.",
    ],
  },
];
        ...
        >
          ...
          <motion.div
            ...
            className="lg:col-span-2 relative rounded-2xl border border-slate-700/60 
                       bg-slate-900/40 p-6 overflow-hidden h-full flex flex-col"
          >
